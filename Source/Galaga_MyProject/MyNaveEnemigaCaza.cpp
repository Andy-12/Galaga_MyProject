...
void AMyNaveEnemigaCaza::BeginPlay()
{
	Super::BeginPlay();
}
...
void AMyNaveEnemigaCaza::Vida(float Resistencia)
{

}

void AMyNaveEnemigaCaza::TipoAtaque(FVector Rayo)
{
}

void AMyNaveEnemigaCaza::TamanoForma()
{
}
