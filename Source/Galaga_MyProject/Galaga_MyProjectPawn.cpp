...
const FName AGalaga_MyProjectPawn::FireForwardBinding("FireForward");
const FName AGalaga_MyProjectPawn::FireRightBinding("FireRight");

AGalaga_MyProjectPawn::AGalaga_MyProjectPawn()
{	
...
void AGalaga_MyProjectPawn::Tick(float DeltaSeconds)
{
...
void AGalaga_MyProjectPawn::FireShot(FVector FireDirection)
{
...
void AGalaga_MyProjectPawn::ShotTimerExpired()
{
	bCanFire = true;
}
