...
#define UE_PROJECT_NAME Galaga_MyProject
#define UE_TARGET_NAME Galaga_MyProjectEditor
#define UE_MODULE_NAME "Galaga_MyProject"
...
#define GALAGA_MYPROJECT_API DLLEXPORT
